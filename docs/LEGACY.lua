--[=[
		...
		# Use MODS v2 instead, aka, the CURRENT branch. #
...
= = = = CHAPTER 1 = = = =
	...
	~!~ DON'T READ THE SOURCE CODE, IT'S PRETTY NASTY. IT WERKS, BUT JUST BARELY. SOMETIMES ERRORS ARE REALLY INDECIPHERABLE (especially if it's a problem with running the code). ~!~
...
= = = = CHAPTER 3 = = = =
	...
	CHANGELOG
       ...
       - Lots more comment support (so put them everywhere!)
		...
		v0.0
		 - Conceived the idea of how the parser currently works.
...
--
--		Many believe that Lua is interpreted, but it is in fact a compiled language.
...
--
--		I'll spare most of you the boring discussion of LASM, but in case you want to learn it,
--		I suggest you read the 'ANoFrillsIntroToLua51VMInstructions.pdf' document, available on the
--		LuaForge website.
--
...
-- Rip()
local lasm = require("LEGACY.lua"); -- this is in the \src\ folder and I don't know how to access it from here
